...
PET-проект представляет собой извлечение, обработку и визуализацию реальных данных при помощи PostgreSQL/pandas/matplotlib и при помощи PostgreSQL/MS Excel/Power Query.
...
### MS Excel
Аналогично извлечь, обработать и визуализировать данные из PostgreSQL в MS Excel по схеме: **PostgreSQL -> Power Query -> Сводная таблица -> Сводная диаграмма**
